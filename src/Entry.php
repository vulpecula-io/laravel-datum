...
class Entry
{
    ...
    {
        return in_array('count', $this->aggregations, true);
    }
    ...
    {
        return in_array('min', $this->aggregations, true);
    }
    ...
    {
        return in_array('max', $this->aggregations, true);
    }
    ...
    {
        return in_array('sum', $this->aggregations, true);
    }
    ...
    {
        return in_array('avg', $this->aggregations, true);
    }
