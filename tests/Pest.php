...
uses(TestCase::class)
    ->beforeEach(function () {
        ...
        Datum::flush();
        Datum::handleExceptionsUsing(fn (Throwable $e) => throw $e);
        Gate::define('viewDatum', fn ($user = null) => true);
        Config::set('datum.ingest.trim.lottery', [1, 1]);
    })
    ->afterEach(function () {
        Str::createUuidsNormally();
        Sleep::fake(false);

        if (Datum::wantsIngesting()) {
